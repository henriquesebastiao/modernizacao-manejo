...
export class UserService {
	 ...
	 * @throws ApiError
	 */
	public static userCreate(requestBody: UserSchema): CancelablePromise<any> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/user/',
			body: requestBody,
	 ...
	 * @throws ApiError
	 */
	public static userUpdate(userId: number, requestBody: UserSchema): CancelablePromise<any> {
		return __request(OpenAPI, {
			method: 'PATCH',
			url: '/user/{user_id}',
			path: {
