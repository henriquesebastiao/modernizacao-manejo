...
export class AnimalService {
	 ...
	 * @throws ApiError
	 */
	public static animalCreate(requestBody: AnimalSchema): CancelablePromise<AnimalSchema> {
		return __request(OpenAPI, {
			method: 'POST',
			url: '/animal/',
			body: requestBody,
	 ...
	 * @throws ApiError
	 */
	public static animalUpdate(animalId: number, requestBody: AnimalSchema): CancelablePromise<any> {
		return __request(OpenAPI, {
			method: 'PATCH',
			url: '/animal/{animal_id}',
			path: {
