<script lang="ts">
	import {RadioGroup, RadioItem, Stepper, Step} from '@skeletonlabs/skeleton';
...
<div class="flex justify-center items-center">
	<div class="card w-[600px] shadow-2xl p-4">
		<Stepper stepTerm="Passo" buttonBackLabel="← Voltar" buttonNextLabel="Próximo →" buttonCompleteLabel="Registrar">
			<Step active>
				<svelte:fragment slot="header">Adicionar animal</svelte:fragment>				<div class="flex w-full flex-col space-y-4 mt-7">
					<label>
